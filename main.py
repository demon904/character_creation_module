...
def attack(char_name: str, char_class: str) -> str:
    if char_class == 'warrior':
        return (f'{char_name} нанёc урон врагу равный {5 + randint(3, 5)}')
    if char_class == 'mage':
        return (f'{char_name} нанёс урон врагу равный {5 + randint(5, 10)}')
    if char_class == 'healer':
        return (f'{char_name} нанёс урон врагу равный {5 + randint(-3, -1)}')
...
def choice_char_class() -> str:
    ...
    while approve_choice != 'y':
        char_class = input('За которого хочешь играть:warrior,mage,healer:')
        if char_class == 'warrior':
            print('Воитель — дерзкий воин ближнего боя. Сильный, выносливый.')
        if char_class == 'mage':
            print('Маг — воин дальнего боя. Обладает высоким интеллектом.')
        if char_class == 'healer':
            print('Лекарь — заклинатель. Черпает силы из природы, и духов.')
        approve_choice = input('Нажми (Y), подтвердить выбор ').lower()
    return char_class
